...
div.innerHTML; // tengo el texto dentro del párrafo con el id '#createdBy'
div.innerHTML += 'Hans Garcia'; 
//const div = document.querySelector('#createdBy').innerHTML += " Hans Garcia";;
...
function ToDo (description) {
  // Tu código acá:
  this.description = description;//seteando
  this.complete = false;//seteando
}
...
div.classList.add('toDoShell');
const span = document.createElement('span');
span.innerHTML = todo.description;
span.id = index;
if (todo.complete) {
  span.classList.add('completeText');
}
